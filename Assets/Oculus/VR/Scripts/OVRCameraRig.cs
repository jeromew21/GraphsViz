...
#region Unity Messages
	...
	protected virtual void UpdateAnchors()
	{
		...
		centerEyeAnchor.localRotation = InputTracking.GetLocalRotation(UnityEngine.XR.XRNode.CenterEye);
		leftEyeAnchor.localRotation = monoscopic ? centerEyeAnchor.localRotation : InputTracking.GetLocalRotation(UnityEngine.XR.XRNode.LeftEye);
		rightEyeAnchor.localRotation = monoscopic ? centerEyeAnchor.localRotation : InputTracking.GetLocalRotation(UnityEngine.XR.XRNode.RightEye);

		leftHandAnchor.localRotation = InputTracking.GetLocalRotation(UnityEngine.XR.XRNode.LeftHand);
		rightHandAnchor.localRotation = InputTracking.GetLocalRotation(UnityEngine.XR.XRNode.RightHand);

		trackerAnchor.localPosition = tracker.position;

		centerEyeAnchor.localPosition = InputTracking.GetLocalPosition(UnityEngine.XR.XRNode.CenterEye);
		leftEyeAnchor.localPosition = monoscopic ? centerEyeAnchor.localPosition : InputTracking.GetLocalPosition(UnityEngine.XR.XRNode.LeftEye);
		rightEyeAnchor.localPosition = monoscopic ? centerEyeAnchor.localPosition : InputTracking.GetLocalPosition(UnityEngine.XR.XRNode.RightEye);

		leftHandAnchor.localPosition = InputTracking.GetLocalPosition(UnityEngine.XR.XRNode.LeftHand);
		rightHandAnchor.localPosition = InputTracking.GetLocalPosition(UnityEngine.XR.XRNode.RightHand);
	...
	public virtual Matrix4x4 ComputeTrackReferenceMatrix()
	{
		...
		headPose.position = InputTracking.GetLocalPosition(UnityEngine.XR.XRNode.Head);
		headPose.orientation = InputTracking.GetLocalRotation(UnityEngine.XR.XRNode.Head);
