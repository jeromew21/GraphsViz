...
public class OVRDisplay
{
	...
	public Vector3 GetNodeStateProperty(UnityEngine.XR.XRNode nodeType, NodeStatePropertyType propertyType)
	{
...
#if UNITY_2017_1_OR_NEWER
			return GetNodeStateProperty(UnityEngine.XR.XRNode.Head, NodeStatePropertyType.Acceleration);
#else
...
#if UNITY_2017_2_OR_NEWER
			return GetNodeStateProperty(UnityEngine.XR.XRNode.Head, NodeStatePropertyType.AngularAcceleration);
#else
...
#if UNITY_2017_1_OR_NEWER
			return GetNodeStateProperty(UnityEngine.XR.XRNode.Head, NodeStatePropertyType.Velocity);
#else
...
#if UNITY_2017_2_OR_NEWER
			return GetNodeStateProperty(UnityEngine.XR.XRNode.Head, NodeStatePropertyType.AngularVelocity);
#else
